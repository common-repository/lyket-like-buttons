    ...
    submit_button(); ?>
          ...
          <div class="lk-flex__fixed">
            ...
            <?php if ($lyket_active_tab == 'user_settings') : ?>
              ...
              <h4>Pricing</h4>
              <div>
                <p>Lyket'pricing is based on your website visualizations, called pageviews, so it charges you only if your website is successful!</p>
                <p>To know our current offers and pricing policy read <a href="https://lyket.dev/pricing" target="_blank">our pricing page</a>!</p>
              </div>
            <?php endif; ?>
            <h4>About</h4>
