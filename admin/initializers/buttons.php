...
function register_buttons()
{
    ...
    lyket_register_post_buttons('Enable buttons in post excerpts', 'lyket_post_excerpt_enable', 'lyket_render_excerpt_enable_input');
...
{
    echo '<p>In this section you can edit and customize buttons that will appear on your posts. You can change colors and shapes and choose where you want them to be shown in your page (vertical & horizontal alignment)</p>';
}

function lyket_render_page_section()
{
    echo '<p>In this section you can edit and customize buttons that will appear on your pages. You can change colors and shapes and choose where you want them to be shown in your page (vertical & horizontal alignment)</p>';
}
