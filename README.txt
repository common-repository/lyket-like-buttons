...
Widget changes are thoroughly documented on [the official repo of the project](https://github.com/lyket-dev/lyket/blob/master/CHANGELOG.md)

- 1.1 First stable version of Lyket like buttons
- 1.2 Fixed post excerpts double button. Added a new option to disable buttons in post excerpts.
